...
void Game::setupBathroomMap(){
	...
	this->_mapBackground = FullMapBackground(*this->_graphicsAssociated, ASSETS_PATH("/banheiroBackground.png") , this->_mapWidth, this->_mapHeight, 0, 0);
...
void Game::setupRoomMap(){
	...
	this->_mapBackground = FullMapBackground(*this->_graphicsAssociated, ASSETS_PATH("/quartoBackground.png") , this->_mapWidth, this->_mapHeight, 0, 0);
...
void Game::setupTutorialMap(){
	...
	this->_mapBackground = FullMapBackground(*this->_graphicsAssociated, ASSETS_PATH("/tutorialbackground.png") , this->_mapWidth, this->_mapHeight, 0, 0);
