...
void PauseMenu::setupButtons(){
	...
	this->_buttonsVector.emplace_back(MenuButton("continue", *this->_graphicsAssociated, 1/3.f, 3/8.f, ASSETS_PATH("/PauseMenuButtons.png"), 1/3.f, 1/6.f, *this));
	...
	this->_buttonsVector.emplace_back(MenuButton("backToMainMenu", *this->_graphicsAssociated, 1/3.f, 5/8.f, ASSETS_PATH("/PauseMenuButtons.png"), 1/3.f, 1/6.f, *this));
